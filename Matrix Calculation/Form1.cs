...
namespace Matrix_Calculation
{
    ...
    #region Мораль
        /*
         * Операции с матрицами, которые ты берёшь из всяких DataGridView
         * лучше проводить путём запихивания данных из этой сетки в 
         * массив матрицы. Иначе запутаешься и не найдёшь ошибку, как я :с
        */
        #endregion
